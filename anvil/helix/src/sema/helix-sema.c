/*
 * sema.c - Semantic analysis for the Anvil compiler
 *
...
static void sema_error(SemaCtx *ctx, int line, const char *fmt, ...) {
    ...
    int col = 0;
    const char *source = anv_get_current_file_source();
    ...
    if (strstr(msg, "undefined variable") || strstr(msg, "undeclared variable"))
        err_code = "E301";
    else if (strstr(msg, "is already declared") || strstr(msg, "is already defined")) {
        if (strstr(msg, "struct"))
            err_code = "E510";
        else if (strstr(msg, "function"))
            err_code = "E304";
        else
            err_code = "E301"; // redeclared variable
    } else if (strstr(msg, "is not a function") || strstr(msg, "undefined function"))
        err_code = "E302";
    else if (strstr(msg, "expects") && strstr(msg, "argument"))
        err_code = "E303";
    else if (strstr(msg, "outside of function") || strstr(msg, "outside function"))
        err_code = "E306";
    else if (strstr(msg, "type mismatch") || (strstr(msg, "expects") && strstr(msg, "got")))
        err_code = "E401";
    else if (strstr(msg, "cannot assign") || strstr(msg, "assignment to struct") || strstr(msg, "cannot be assigned"))
        err_code = "E402";
    else if (strstr(msg, "not supported in") || strstr(msg, "cannot print"))
        err_code = "E403";
    else if (strstr(msg, "unknown struct type"))
        err_code = "E501";
    else if (strstr(msg, "duplicate field"))
        err_code = "E502";
    else if (strstr(msg, "has no field"))
        err_code = "E503";
    else if (strstr(msg, "initialized more than once"))
        err_code = "E505";
    else if (strstr(msg, "field value(s)"))
        err_code = "E506";
    else if (strstr(msg, "member access"))
        err_code = "E508";
    else if (strstr(msg, "cannot convert"))
        err_code = "E404";
    else if (strstr(msg, "missing initializer"))
        err_code = "E504";
    else if (strstr(msg, "cannot be instantiated"))
        err_code = "E507";
    else if (strstr(msg, "recursive type"))
        err_code = "E509";

    anv_report_error(SEV_ERROR, err_code, line, col, NULL, NULL, "%s", msg);
    ctx->had_error = 1;
}
