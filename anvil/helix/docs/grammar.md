...
Helix is a native programming language designed for writing command-line applications. It features a JavaScript-like syntax and compiles to native x86-64 Win64 assembly via the Anvil compiler.
...
> Due to calling convention constraints in the current Anvil x86-64 assembly generator, **functions are strictly limited to a maximum of 4 parameters**.
...
### Importing Modules
* **Import All (Anvil Root)**: `import <module>`
* **Import All (Project Root)**: `import "<file>.hlx"`
* **Selective Import (Anvil Root)**: `import <module> { <func1>, <func2> }`
