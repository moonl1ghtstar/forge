/*
 * x86-encode.h - x86-64 instruction encoder for Forge ASM
 *
 * Encodes AsmStatement (instruction form) into raw bytes.
 * Supports the subset of x86-64 instructions emitted by Forge's codegen
 ...
 * caller-managed list.
 */
#ifndef FORGE_X86_ENCODE_H
#define FORGE_X86_ENCODE_H
