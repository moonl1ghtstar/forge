...
Helix is a statically compiled programming language developed for the **Forge Compiler**. Its syntax is inspired by JavaScript while producing efficient native x86-64 executables through a multi-stage compiler pipeline.
...
Forge automatically wraps top-level statements into `main()`.
...
Forge compiles Helix using several compilation stages.
...
Helix and Forge are open-source projects.
